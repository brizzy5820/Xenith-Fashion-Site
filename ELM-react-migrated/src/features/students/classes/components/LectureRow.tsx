      ...
      <article className="p-4">
        <div className="flex gap-3">
          ...
          <div className="min-w-0 flex-1">
            <Link
              to={`/students/classes/lectures/${lecture.id}`}
...
function LectureResource({ to, label, icon: Icon, available }: LectureResourceProps) {
  if (!available || !to) {
    return (
