  ...
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      ...
      <button
        ...
        className="flex h-10 min-w-[110px] items-center justify-center gap-2 rounded-lg bg-white px-4 text-sm font-medium text-gray-600 shadow-sm w-25 transition hover:bg-gray-50"
      >
